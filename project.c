...
int main()
{
    int randomGuess1, randomGuess2, actualNumber1, actualNumber2, i1, i2;
    srand(time(0));
    actualNumber1 = rand() % 100 + 1;
    actualNumber2 = rand() % 100 + 1;
    ...
    for (i1 = 4; i1 >= 0; i1--)
    {
        ...
        if (randomGuess1 == actualNumber1)
        {
            printf("Congrats Player1 !,You guess it right..\nNumber of attempts left are %d\n", i1);
            break;
        }
        if (randomGuess1 > actualNumber1)
        {
            printf("Try a smaller number.\tNumber of attempts left are %d\n", i1);
        }
        if (randomGuess1 < actualNumber1)
        {
    ...
    for (i2 = 4; i2 >= 0; i2--)
    {
        ...
        if (randomGuess2 == actualNumber2)
        {
            printf("Congrats Player2 !,You guess it right..\nNumber of attempts left are %d\n", i2);
            break;
        }
        if (randomGuess2 > actualNumber2)
        {
